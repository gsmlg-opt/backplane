...
This project is indexed by GitNexus as **backplane** (6623 symbols, 7990 relationships, 112 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
