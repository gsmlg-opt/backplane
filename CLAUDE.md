...
This project is indexed by GitNexus as **backplane** (1204 symbols, 1188 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
