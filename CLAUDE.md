...
This project is indexed by GitNexus as **backplane** (1045 symbols, 1030 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
