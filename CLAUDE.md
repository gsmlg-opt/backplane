...
This project is indexed by GitNexus as **backplane** (1907 symbols, 2014 relationships, 14 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
