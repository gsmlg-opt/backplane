...
This project is indexed by GitNexus as **backplane** (3044 symbols, 5578 relationships, 217 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
