...
This project is indexed by GitNexus as **backplane** (3574 symbols, 6203 relationships, 270 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
