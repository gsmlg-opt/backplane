...
This project is indexed by GitNexus as **backplane** (1552 symbols, 1644 relationships, 12 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
