defmodule Backplane.Admin.Router do
  ...
  scope "/", Backplane.Admin do
    ...
    live("/system/logs/llm/:id", LogsLlmLive, :show)
    live("/system/logs/mcp", LogsMcpLive, :index)
    live("/system/logs/mcp/:id", LogsMcpLive, :show)
    live("/system/logs/audit", LogsAuditLive, :index)
    live("/system/logs/jobs", LogsJobsLive, :index)
    live("/system/logs/sinks", LogsSinksLive, :index)
