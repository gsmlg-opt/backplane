defmodule Backplane.McpProtocol.Telemetry do
  @moduledoc false

  @doc """
  Execute a telemetry event with the Backplane.McpProtocol MCP namespace.

  ## Parameters
  - `event_name` - List of atoms for the event name, excluding the :backplane_mcp_protocol prefix
