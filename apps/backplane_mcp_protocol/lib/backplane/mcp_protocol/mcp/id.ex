defmodule Backplane.McpProtocol.MCP.ID do
  @moduledoc false
  ...
  ## Examples
      ...
      iex> id = Backplane.McpProtocol.MCP.ID.generate()
      iex> is_binary(id)
      true
  """
  ...
  ## Examples
      ...
      iex> id = Backplane.McpProtocol.MCP.ID.generate_request_id()
  ...
  ## Examples
      ...
      iex> id = Backplane.McpProtocol.MCP.ID.generate_error_id()
  ...
  ## Examples
      ...
      iex> token = Backplane.McpProtocol.MCP.ID.generate_progress_token()
  ...
  ## Examples
      ...
      iex> id = Backplane.McpProtocol.MCP.ID.generate_session_id()
  ...
  ## Examples
      ...
      iex> id = Backplane.McpProtocol.MCP.ID.generate()
      iex> timestamp = Backplane.McpProtocol.MCP.ID.timestamp_from_id(id)
      iex> is_integer(timestamp)
      true
      
      iex> Backplane.McpProtocol.MCP.ID.timestamp_from_id("invalid-id")
      nil
  """
  ...
  ## Examples
      ...
      iex> id = Backplane.McpProtocol.MCP.ID.generate()
      iex> Backplane.McpProtocol.MCP.ID.valid?(id)
      true
      
      iex> Backplane.McpProtocol.MCP.ID.valid?("invalid-id")
      false
  """
  ...
  ## Examples
      ...
      iex> id = Backplane.McpProtocol.MCP.ID.generate_request_id()
      iex> Backplane.McpProtocol.MCP.ID.valid_request_id?(id)
      true
      
      iex> Backplane.McpProtocol.MCP.ID.valid_request_id?("not-an-id")
      false
  """
  ...
  ## Examples
      ...
      iex> token = Backplane.McpProtocol.MCP.ID.generate_progress_token()
      iex> Backplane.McpProtocol.MCP.ID.valid_progress_token?(token)
      true
      
      iex> Backplane.McpProtocol.MCP.ID.valid_progress_token?("not-a-token")
      false
  """
