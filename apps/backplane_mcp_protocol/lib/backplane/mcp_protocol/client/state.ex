defmodule Backplane.McpProtocol.Client.State do
  @moduledoc false
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Client.State.get_request(state, "req_123")
  ...
  ## Examples
      ...
      iex> {request_info, updated_state} = Backplane.McpProtocol.Client.State.remove_request(state, "req_123")
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Client.State.handle_request_timeout(state, "req_123")
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.register_progress_callback(state, "token123", fn token, progress, total -> IO.inspect({token, progress, total}) end)
  ...
  ## Examples
      ...
      iex> callback = Backplane.McpProtocol.Client.State.get_progress_callback(state, "token123")
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.unregister_progress_callback(state, "token123")
      iex> Map.has_key?(updated_state.progress_callbacks, "token123")
      false
  """
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.set_log_callback(state, fn level, data, logger -> IO.inspect({level, data, logger}) end)
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.clear_log_callback(state)
  ...
  ## Examples
      ...
      iex> callback = Backplane.McpProtocol.Client.State.get_log_callback(state)
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.update_server_info(state, %{"resources" => %{}}, %{"name" => "TestServer"})
  ...
  ## Examples
      ...
      iex> requests = Backplane.McpProtocol.Client.State.list_pending_requests(state)
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Client.State.get_server_capabilities(state)
      %{"resources" => %{}, "tools" => %{}}
  """
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Client.State.get_server_info(state)
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.merge_capabilities(state, %{"tools" => %{"execute" => true}})
  ...
  ## Returns
    ...
    * `{:error, %Backplane.McpProtocol.MCP.Error{}}` if the method is not supported

  ## Examples

      iex> Backplane.McpProtocol.Client.State.validate_capability(state_with_resources, "resources/list")
      :ok
      
      iex> {:error, error} = Backplane.McpProtocol.Client.State.validate_capability(state_without_tools, "tools/list")
      iex> error.reason
      :method_not_found
  """
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.add_root(state, "file:///home/user/project", "My Project")
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.remove_root(state, "file:///home/user/project")
      iex> updated_state.roots
      []
  """
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Client.State.get_root_by_uri(state, "file:///home/user/project")
      %{uri: "file:///home/user/project", name: "My Project"}
  """
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Client.State.list_roots(state)
      [%{uri: "file:///home/user/project", name: "My Project"}]
  """
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.clear_roots(state)
      iex> updated_state.roots
      []
  """
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.set_sampling_callback(state, callback)
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Client.State.get_sampling_callback(state)
      nil
  """
  ...
  ## Examples
      ...
      iex> updated_state = Backplane.McpProtocol.Client.State.clear_sampling_callback(state)
