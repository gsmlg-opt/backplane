defmodule Backplane.McpProtocol.Protocol.Registry do
  @moduledoc """
  ...
  ## Usage
      ...
      iex> Backplane.McpProtocol.Protocol.Registry.get("2025-11-25")
  ...
  @versions %{
    "2024-11-05" => Backplane.McpProtocol.Protocol.V2024_11_05,
    "2025-03-26" => Backplane.McpProtocol.Protocol.V2025_03_26,
    "2025-06-18" => Backplane.McpProtocol.Protocol.V2025_06_18,
    "2025-11-25" => Backplane.McpProtocol.Protocol.V2025_11_25,
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Protocol.Registry.get("2025-06-18")
      {:ok, Backplane.McpProtocol.Protocol.V2025_06_18}

      iex> Backplane.McpProtocol.Protocol.Registry.get("unknown")
      :error
  """
  @spec get(version()) :: {:ok, module()} | :error
  def get(version), do: Map.fetch(@versions, version)

  @doc "Returns the lifecycle and wire profile for a supported version."
  @spec profile(version()) :: {:ok, Profile.t()} | :error
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Protocol.Registry.negotiate("2025-11-25")
      {:ok, "2025-11-25", Backplane.McpProtocol.Protocol.V2025_11_25}
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Protocol.Registry.negotiate("2025-03-26", ["2025-11-25", "2025-03-26"])
      {:ok, "2025-03-26", Backplane.McpProtocol.Protocol.V2025_03_26}

      iex> Backplane.McpProtocol.Protocol.Registry.negotiate("2024-11-05", ["2025-11-25", "2025-03-26"])
      {:ok, "2025-11-25", Backplane.McpProtocol.Protocol.V2025_11_25}
  """
