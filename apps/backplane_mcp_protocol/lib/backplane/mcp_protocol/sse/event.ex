defmodule Backplane.McpProtocol.SSE.Event do
  @moduledoc false
  ...
  ## Examples
      ...
      iex> event = %Backplane.McpProtocol.SSE.Event{data: "hello"}
      iex> inspect(event)
      "event: message\\ndata: hello\\n\\n"
      
      iex> event = %Backplane.McpProtocol.SSE.Event{id: "123", event: "ping", data: "pong"}
      iex> inspect(event)
      "id: 123\\nevent: ping\\ndata: pong\\n\\n"
  """
