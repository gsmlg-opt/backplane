defmodule Backplane.McpProtocol.Protocol do
  @moduledoc """
  ...
  `Backplane.McpProtocol.Protocol.*` via `Backplane.McpProtocol.Protocol.Registry`.

  ## Adding a new protocol version

  1. Create a new module under `lib/backplane/mcp_protocol/protocol/` implementing `Backplane.McpProtocol.Protocol.Behaviour`
  2. Register it in `Backplane.McpProtocol.Protocol.Registry`
  """
  ...
  ## Examples
      ...
      iex> Backplane.McpProtocol.Protocol.get_module("2025-06-18")
