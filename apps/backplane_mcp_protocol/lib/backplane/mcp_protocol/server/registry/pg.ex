defmodule Backplane.McpProtocol.Server.Registry.PG do
  @moduledoc """
  ...
  The default `Backplane.McpProtocol.Server.Registry.Local` stores session PIDs in a node-local
  ...
  ## Usage
      ...
      children = [
        {MyServer, transport: {:streamable_http, start: true}, registry: {Backplane.McpProtocol.Server.Registry.PG, []}}
      ]
  ...
  `Backplane.McpProtocol.Server.Session.Store` implementation (e.g. Redis or a database) so
