if Code.ensure_loaded?(JOSE) do
  defmodule Backplane.McpProtocol.Server.Authorization.JWTValidator do
    @moduledoc """
    ...
    (`Backplane.McpProtocol.Server.Authorization.validate_audience/2` and
    ...
    defp do_fetch_jwks(jwks_uri, cache_key) do
      ...
      case Finch.request(request, Backplane.McpProtocol.Finch,
