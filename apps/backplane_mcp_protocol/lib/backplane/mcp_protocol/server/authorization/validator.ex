defmodule Backplane.McpProtocol.Server.Authorization.Validator do
  @moduledoc """
  ...
  Two built-in implementations are provided:
    ...
    * `Backplane.McpProtocol.Server.Authorization.JWTValidator` — validates JWTs using JWKS (requires `:jose`)
    * `Backplane.McpProtocol.Server.Authorization.IntrospectionValidator` — validates opaque tokens via RFC 7662
  ...
  @type token :: String.t()
  @type config :: Backplane.McpProtocol.Server.Authorization.config()
  @type claims :: map()
  ...
  `Backplane.McpProtocol.Server.Authorization.normalize_claims/1` is called by the authorization
