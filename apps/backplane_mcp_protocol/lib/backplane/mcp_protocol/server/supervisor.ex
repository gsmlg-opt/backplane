defmodule Backplane.McpProtocol.Server.Supervisor do
  @moduledoc false
  ...
  ## Parameters
    ...
    * `server` - The module implementing `Backplane.McpProtocol.Server`
  ...
  defp resolve_task_store(opts, _server) do
    case Keyword.get(opts, :task_store) do
      ...
      nil -> {Backplane.McpProtocol.Server.TaskStore.Local, []}
    end
  end
