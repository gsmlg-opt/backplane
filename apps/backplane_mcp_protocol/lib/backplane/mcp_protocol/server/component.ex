defmodule Backplane.McpProtocol.Server.Component do
  @moduledoc false
  ...
  alias Backplane.McpProtocol.Server.Component.URITemplate
  ...
  defmacro __using__(opts) when is_list(opts) do
    ...
    quote generated: true do
      ...
      import Backplane.McpProtocol.Server.Component,
        only: [
          schema: 1,
          output_schema: 1,
          field: 3,
  ...
  ## Examples
      ...
      ...> end
      iex> Backplane.McpProtocol.Server.Component.get_description(MyTool)
      "A helpful tool"
      ...
      ...> end
      iex> Backplane.McpProtocol.Server.Component.get_description(MyToolWithCallback)
  ...
  ## Examples
      ...
      ...>   use Backplane.McpProtocol.Server.Component, type: :tool
      ...> end
      iex> Backplane.McpProtocol.Server.Component.get_type(MyTool)
      :tool
  """
  ...
  ## Returns
    * `true` if the module uses `Backplane.McpProtocol.Server.Component`
    * `false` otherwise
  ...
  ## Examples
      ...
      ...>   use Backplane.McpProtocol.Server.Component, type: :tool
      ...> end
      iex> Backplane.McpProtocol.Server.Component.component?(MyTool)
      true

      iex> defmodule NotAComponent do
      ...>   def hello, do: :world
      ...> end
      iex> Backplane.McpProtocol.Server.Component.component?(NotAComponent)
      false
  """
