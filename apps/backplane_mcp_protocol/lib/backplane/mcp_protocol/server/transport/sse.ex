defmodule Backplane.McpProtocol.Server.Transport.SSE do
  @moduledoc """
  ...
  > of the Streamable HTTP transport (`Backplane.McpProtocol.Server.Transport.StreamableHTTP`).
  >
  ...
  >
  > For new implementations, please use `Backplane.McpProtocol.Server.Transport.StreamableHTTP` instead.
  ...
  SSE transport is typically started through the server supervisor:
      ...
      Backplane.McpProtocol.Server.start_link(MyServer, [],
        transport: :sse,
  ...
  For integration with existing Phoenix/Plug applications:
      ...
      # In your router
      forward "/sse", Backplane.McpProtocol.Server.Transport.SSE.Plug,
        server: MyApp.MCPServer,
        mode: :sse

      forward "/messages", Backplane.McpProtocol.Server.Transport.SSE.Plug,
        server: MyApp.MCPServer,
        mode: :post
  ...
  @deprecated "Use Backplane.McpProtocol.Server.Transport.StreamableHTTP instead"
  ...
  defschema(:parse_options, [
    {:server, {:required, Backplane.McpProtocol.get_schema(:process_name)}},
