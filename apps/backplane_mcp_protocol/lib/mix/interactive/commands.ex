defmodule Mix.Interactive.Commands do
  ...
  alias Backplane.McpProtocol.Transport.SSE
  ...
  defp list_tools(client, loop_fn) do
    ...
    case Backplane.McpProtocol.Client.list_tools(client, timeout_opts) do
  ...
  defp perform_tool_call(client, tool_name, tool_args, timeout_opts) do
    ...
    case Backplane.McpProtocol.Client.call_tool(client, tool_name, tool_args, timeout_opts) do
  ...
  defp list_prompts(client, loop_fn) do
    ...
    case Backplane.McpProtocol.Client.list_prompts(client, timeout_opts) do
  ...
  defp perform_get_prompt(client, prompt_name, prompt_args, timeout_opts) do
    ...
    case Backplane.McpProtocol.Client.get_prompt(
           client,
           prompt_name,
           prompt_args,
           timeout_opts
  ...
  defp list_resources(client, loop_fn) do
    ...
    case Backplane.McpProtocol.Client.list_resources(client, timeout_opts) do
  ...
  defp list_resource_templates(client, loop_fn) do
    ...
    case Backplane.McpProtocol.Client.list_resource_templates(client, timeout_opts) do
  ...
  defp read_resource(client, loop_fn) do
    ...
    case Backplane.McpProtocol.Client.read_resource(client, resource_uri, timeout_opts) do
      {:ok, %Response{result: result}} ->
  ...
  defp ping_server(client, loop_fn) do
    ...
    case Backplane.McpProtocol.Client.ping(client, timeout_opts) do
      :pong ->
