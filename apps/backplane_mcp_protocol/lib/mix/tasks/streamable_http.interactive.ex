defmodule Mix.Tasks.Backplane.McpProtocol.StreamableHttp.Interactive do
  ...
  * `--header` - Add a header to requests (can be specified multiple times)
  ...
  ## Examples
      ...
      mix backplane.mcp_protocol.streamable_http.interactive --base-url http://localhost:8000
      mix backplane.mcp_protocol.streamable_http.interactive --header "Authorization: Bearer token123"
      mix backplane.mcp_protocol.streamable_http.interactive --header "X-API-Key: secret" --header "X-Custom: value"
  """
