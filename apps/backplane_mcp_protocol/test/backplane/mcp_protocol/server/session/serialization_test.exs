defmodule Backplane.McpProtocol.Server.Session.SerializationTest do
  ...
  describe "to_serializable/1" do
    test "produces a JSON-safe map from session state" do
      ...
      assert result.protocol_module == "Elixir.Backplane.McpProtocol.Protocol.V2025_03_26"
  ...
  defp build_state(overrides \\ []) do
    defaults = %{
      ...
      registry: Backplane.McpProtocol.Server.Registry,
