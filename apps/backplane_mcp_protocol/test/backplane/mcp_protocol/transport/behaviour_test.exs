defmodule Backplane.McpProtocol.Transport.BehaviourTest do
  @moduledoc """
  Tests for the functional `Backplane.McpProtocol.Transport` behaviour implementations.
  ...
  alias Backplane.McpProtocol.Transport.StreamableHTTP, as: ClientHTTP
  ...
  describe "Client SSE transport" do
    ...
    test "extract_metadata/2 with SSE Event struct" do
      ...
      event = %Backplane.McpProtocol.SSE.Event{event: "message", data: "data", id: "evt_1"}
