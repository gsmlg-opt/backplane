defmodule Backplane.McpProtocol.ProtocolTest do
  ...
  describe "get_module/1" do
    test "returns module for known version" do
      assert {:ok, Backplane.McpProtocol.Protocol.V2024_11_05} = Protocol.get_module("2024-11-05")
      assert {:ok, Backplane.McpProtocol.Protocol.V2025_03_26} = Protocol.get_module("2025-03-26")
      assert {:ok, Backplane.McpProtocol.Protocol.V2025_06_18} = Protocol.get_module("2025-06-18")
    end
