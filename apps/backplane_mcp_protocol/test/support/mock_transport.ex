defmodule MockTransport do
  @moduledoc """
  Default Mox stub-with module for `Backplane.McpProtocol.MockTransport`.
  ...
  `Backplane.McpProtocol.MCP.Case` setup, which captures the test pid and forwards every send
