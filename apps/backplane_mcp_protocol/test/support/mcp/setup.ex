defmodule Backplane.McpProtocol.MCP.Setup do
  @moduledoc false
  ...
  needs the forward but no per-call assertion.
      ...
      expect(Backplane.McpProtocol.MockTransport, :send_message, forwarder(self()))
  """
  ...
  def initialized_client(context) do
    ...
    allow(Backplane.McpProtocol.MockTransport, self(), fn -> client end)
