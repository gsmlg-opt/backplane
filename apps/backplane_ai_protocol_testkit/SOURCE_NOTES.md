...
This package is prepared from the pinned Backplane, Sigma, and Synapsis inventories in
`docs/ai-protocol/evidence/source_inventory.md`; no source code has been copied yet.
