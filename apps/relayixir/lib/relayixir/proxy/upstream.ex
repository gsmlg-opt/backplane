defmodule Relayixir.Proxy.Upstream do
  ...
  @type t :: %__MODULE__{
          ...
          inject_request_headers: [{String.t(), String.t() | nil}],
          default_request_headers: [{String.t(), String.t()}],
          proxy: nil | :environment,
  ...
  defp build_upstream(config, route) do
    %__MODULE__{
      ...
      default_request_headers: Map.get(route, :default_request_headers, []),
