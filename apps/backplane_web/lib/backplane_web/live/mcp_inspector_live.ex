defmodule BackplaneWeb.McpInspectorLive do
  ...
  Users configure all connection details manually — no upstream selection.
  """
    ...
    <div>
      <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-on-surface-variant">
          Connect to any MCP server via HTTP or stdio. Configure connection details, initialize, and explore available tools.
        </p>
      </div>
