defmodule Backplane.Jobs.McpProxyRetention do
  @moduledoc """
  Oban worker that deletes MCP root proxy access records older than configured retention.
  """
  ...
  def perform(%Oban.Job{}) do
    ...
    from(r in ProxyRequest, where: r.inserted_at < ^cutoff)
    |> Repo.delete_all()
