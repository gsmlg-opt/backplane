defmodule Backplane.Proxy.UpstreamTest do
  ...
  describe "protocol-package negotiation" do
    ...
    test "auto falls back after discovery returns JSON-RPC method not found" do
      url = start_http_fixture(mode: :discover_jsonrpc_error)

      pid =
        start_test_upstream(
          http_config("auto-jsonrpc-legacy", url,
    ...
    for mode <- [:discover_500, :discover_malformed] do
