...
This project is indexed by GitNexus as **backplane** (3654 symbols, 6290 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
