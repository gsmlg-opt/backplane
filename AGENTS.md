...
This project is indexed by GitNexus as **backplane** (2086 symbols, 2196 relationships, 14 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
