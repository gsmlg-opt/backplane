...
This project is indexed by GitNexus as **backplane** (2976 symbols, 5509 relationships, 215 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
