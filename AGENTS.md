...
This project is indexed by GitNexus as **backplane** (1647 symbols, 1740 relationships, 12 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
