...
This project is indexed by GitNexus as **backplane** (1007 symbols, 992 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
