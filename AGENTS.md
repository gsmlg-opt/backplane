...
This project is indexed by GitNexus as **backplane** (5238 symbols, 6730 relationships, 116 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
