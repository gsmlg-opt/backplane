...
This project is indexed by GitNexus as **backplane** (1611 symbols, 1704 relationships, 12 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
