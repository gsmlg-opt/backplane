...
This project is indexed by GitNexus as **backplane** (1697 symbols, 1790 relationships, 12 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
